    ...
    return (
        <main className="relative min-h-[calc(100vh-4rem)] overflow-hidden">
            <section className="container mx-auto flex flex-col items-center px-4 pb-16 text-center sm:pt-10">
                ...
                {/* Hero heading */}
                <h1 className="mb-4 flex max-w-4xl flex-wrap items-center justify-center gap-2 text-3xl font-bold tracking-tight text-balance sm:text-4xl lg:text-5xl xl:text-6xl">
                ...
                <p className="mb-6 max-w-2xl text-sm text-muted-foreground sm:text-base md:text-lg">
                    CinePro is an open‑source ecosystem for building your own
                    movie & TV experience: OMSS‑compliant core engine, modern
                    UI, and living documentation in one stack.
                </p>

                {/* Supporting line */}
                <p className="mb-8 max-w-2xl text-xs text-muted-foreground sm:text-sm">
                    Designed for self‑hosting and homelabs — resolve dozens of
                    sources per title, plug in your own UI, and stay in control
                    of your media setup.
                </p>
                ...
                <div className="mb-14 flex flex-wrap justify-center gap-3 text-xs text-muted-foreground sm:text-sm">
                    <Button
                        variant={"ghost"}
                        className="rounded-full border-border transition hover:border-primary/50 hover:shadow-sm"
                        asChild
                    >
                        <Link
                            to={"https://github.com/omss-spec"}
                            target={"_blank"}
                        >
                ...
                <div className="grid w-full max-w-5xl gap-4 md:grid-cols-3">
                    <div className="group relative overflow-hidden rounded-2xl border border-border bg-background/80 p-5 text-left shadow-sm transition hover:border-primary/50 hover:shadow-md">
                        <div className="mb-3 inline-flex items-center rounded-full bg-primary/10 px-2 py-1 text-[0.65rem] font-semibold tracking-[0.16em] text-primary uppercase">
                            Core engine
                        </div>
                        ...
                        <p className="text-xs text-muted-foreground">
                            OMSS‑compliant TypeScript backend that resolves up
                            to 100+ unique sources per movie or show.
                        </p>
                    </div>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-border bg-background/80 p-5 text-left shadow-sm transition hover:border-primary/50 hover:shadow-md">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Next‑gen React UI focused on browsing, watching, and
                            discovery — built on a Fastify + Vite + shadcn
                            stack.
                        </p>
                    </div>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-border bg-background/80 p-5 text-left shadow-sm transition hover:border-primary/50 hover:shadow-md">
                        ...
                        <p className="text-xs text-muted-foreground">
                            ...
                            — core, UI, docs, and more to plug into your stack.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4">
                    <div className="mb-6 flex flex-col gap-2 text-left sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            ...
                            <p className="max-w-xl text-sm text-muted-foreground">
                                ...
                                — mix and match what you need for your setup.
                            </p>
                        </div>
                        <Button
                            variant="ghost"
                    ...
                    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                        ...
                        >
                            ...
                            <p className="text-xs text-muted-foreground">
                                OMSS‑compliant core scraping and streaming
                                engine that powers the entire CinePro ecosystem.
                            </p>
                        </a>
                        ...
                        >
                            ...
                            <p className="text-xs text-muted-foreground">
                                New CinePro frontend built with Fastify + Vite +
                                shadcn — the future UI for{" "}
                                <span className="font-medium text-primary">
                                    ui.cinepro.cc
                                </span>
                                .
                        ...
                        >
                            ...
                            <p className="text-xs text-muted-foreground">
                                ...
                                — API reference, guides, and deployment notes.
                            </p>
                        </a>
                    </div>
                </div>
                ...
                <div className="container mx-auto flex flex-col items-center gap-4 px-4 text-center sm:flex-row sm:justify-between sm:text-left">
                    <div>
                        ...
                        <p className="max-w-xl text-xs text-muted-foreground sm:text-sm">
                            Start with the docs, pull the core, and use it for
                            CinePro/ui or your own custom frontend for your
                            setup!
                        </p>
                    </div>
